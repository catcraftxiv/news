...
<details>
  <summary> Why does it happen? </summary>
  <p> Cause metadata affect all variants of item, for all races and genders, but modded item usually repacing only tall female or male model. Like lets say you downloaded fancy one-piece swimsuit, so it should hide your bottoms (with hands and feets sill in place), but there is not that much vanilla items that fit the description. There is always workarounds, but all of them will make same item for other races work different! </p>
</details>
<br>
